...
public class JDBCUpdate {
	...
	public static void main(String[] args) {
		...
		// 어떤 아이디의 pw, name, email을 변경하지 조회하기 위해
		// 먼저 id를 받고 그 다음
		// pw, name, email을 받아서
		// UPDATE구문에서 조건절에 id를 넣어 타겟을 정하고
		// 나머지 항목만 수정 되도록 처리 해주세요.
		
		// JDBC 순서
		// 1. DB종류 인식
		// 2. 연결하기 (스키마 주소, 아이디, 비밀번호)
		// 3. 쿼리문 발송 준비하기.
		...
		try {
			...
			// 바꿀 아이디 입력받기
			System.out.println("변경할 계정의 아이디를 입력해주세요.");
			...
			// UPDATE userinfo set upw='유저입력비번', uname='유저입력이름', 
			// 			  	 	   ueamil='유저입력이메일', uid='유저입력아이디';
			// 5. 쿼리문 발송 후 변경내역이 DB에 반영 되었는지 체크
