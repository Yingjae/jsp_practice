package kr.co.ict;
// SQL 관련된 요소는 java.sql.*을 임포트 하면 대부분이 다 로드 됩니다.
...
public class JDBCSelect {
	...
	public static void main(String[] args) {
		...
		// MySQL을 연동할 것임을 알리기 위해 forName 내부에 MySQL용 연동 구문을 적습니다.
			...
			// 쿼리문은 연결된 mysql에 날려주기 위해, 쿼리문을 준비합니다.
			...
			// ResultSet은 기본적으로 row갯수 만큼 내부에 데이터를 저장합니다.
			...
			// get 자료형(인덱스번호, 1부터) or get자료형(컬럼명)을 쓰면
			// 해당 컬럼의 자료를 반환합니다.
