<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- 여기에 세션아이디랑 글쓴이 아이디를 비교해서 일치하지 않으면 boardList.do로 리다이렉트 -->
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	<c:if test="${sessionScope.session id ne board.wirter }">
...
<body>
	...
	<form action="http://localhost:8181/MyFirstWeb/boardUpdate.do" method="post">
		<!-- form은 디테일 페이지 양식을 가져오면 됩니다. -->
			...
			최근 수정날짜 : ${board.mdate }<br/>
			본문 : <textarea name="content" rows="30" cols="50">${board.content }</textarea><br/>		
